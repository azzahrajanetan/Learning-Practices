...
#read csv
df = pd.read_csv('/home/azzahrajane/datachallenge/universities-intake-enrolment-and-graduates-by-course.csv')
...
filtered.to_csv('/home/azzahrajane/datachallenge/filtereduni.csv', index=False)

unidf = pd.read_csv('/home/azzahrajane/datachallenge/filtereduni.csv')
print(unidf)
...
unidf.to_csv('/home/azzahrajane/datachallenge/finaluni.csv', index=False)

# POLY DATA

df2 = pd.read_csv('/home/azzahrajane/datachallenge/polytechnics-intake-enrolment-and-graduates-by-course.csv')
...
#save to csv
filtered2.to_csv('/home/azzahrajane/datachallenge/filteredpoly.csv', index=False)

polydf = pd.read_csv('/home/azzahrajane/datachallenge/filteredpoly.csv')
print(polydf)
...
polydf.to_csv('/home/azzahrajane/datachallenge/finalpoly.csv', index=False)
